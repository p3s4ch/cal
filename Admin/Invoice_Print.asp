...
If (AddID <> "") Then
	 ...
	 SQL = "select dbo.getVATRate(DateOfInvoice) as VAT_RATE, * from invoices left join customers ON invoices.CustomerID = Customers.ID WHERE invoices.ID = " & AddID
...
<tr>
<td>  &nbsp; </td> <td> </td><td> </td> <td> <i>See payment options below <br>&nbsp;&nbsp; or
...
min=1
Randomize
randy = Int((max-min+1)*Rnd+min)
orderid = RS("Surname") & AddID & "." & randy
'Response.Write "orderid= " & orderid

%>

<form action="http://orderOnline.me.uk/Calendar/Admin/eComm/takeOff.php" name="frmUser" Method="GET" >
  <input type="hidden" name="amount" value="<%=totIncVat%>" >
  <input type="hidden" name="orderid" value="<%=orderid%>" >

  <input type="submit" name="Submit" value="Pay Now" class="inputSubmit" <%=disableSave%> >

</form> <i> by </i> <img src =gif/credit_card_logos_20.jpg  height="24" width="80"  />  </a> &nbsp; &nbsp; </td>
</tr>
