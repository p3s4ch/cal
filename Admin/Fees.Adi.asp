...
<tr><td><form action="?"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="SearchFor" value="adi.u.house" />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="All Building Costs" class="inputSubmit">
</form></td>


<td><form action="?"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="SearchFor" value="adi.u.house.labour" />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="Payments to builder" class="inputSubmit">
</form></td>

<td><form action="?"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="SearchFor" value="adi.u.house.materials" />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="Building Materials" class="inputSubmit">
</form></td>


<td><form action="?"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="SearchFor" value="adi.u" />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="Adi Record" class="inputSubmit">
</form></td>

<td><form action="?"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="SearchFor" value="adi.u" />
<input type="hidden" name="periodId" value="75" />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="POST 1 MAY 2014" class="inputSubmit">
</form></td>
...
<!--#include file="common\update_fees.asp"-->
...
SQL = "select * from dbo.fees " &  SQL_Where  & " order by [date] desc"
Response.Write "<br>" & SQL & "<br>"

SQL_TOT = "select sum(amount) as tot from dbo.fees " &  SQL_Where
