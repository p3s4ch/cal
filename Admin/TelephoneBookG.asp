...
<h2 ALIGN=CENTER>Telephone Book </h2>



<form action="categories_add.asp" name="frmUser" Method="GET">
...
SQL = "select * from dbo.TelephoneBook " & SQL_Where
Response.Write "<br>" & SQL & "<br>"

SQL_TOT = "select sum(amount) from dbo.fees " &  SQL_Where
...
<%
addEditPgLink="categories_add.asp"
for each x in RS.Fields
%>
