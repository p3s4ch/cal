...
function VerifyData()
{
  ...
  if (cat == "Task" || cat == "Reminder" || cat == "Errand" || cat == "Holiday" || cat == "Kids" || cat == "Telephone Quote" )
  {
...
%>
    ...
    <a href="events_add_admin.asp?uid=<%=uid%>&AddId=<%=AddId%>">
...
<%
if CustomerID <> -1 and CustomerID <> "" then
...
if (  seeAllCustomers )  then 

           sqlWHEREcustomers=" where PUN like '%EV-%' or PUN like '%HM-%'"
...
<tr>
<td bgcolor="#C5D3E7""><font face="Verdana" size="1" color="48576C"><b>Total  &nbsp;  </b></font></td>
<td bgcolor="#C5D3E7""></td>
...
<td valign="bottom">
                   ...
                   <input type="submit" name="Submit" value="Confirm" class="inputSubmit" onclick="return VerifyData()"> &nbsp; &nbsp;
                   </font></td>
</tr>
