...
sql_step1 = "select CustomerID , Team from dbo.Preferences where uid  = " & uid
Set RS_ONE = SQLCN.Execute(sql_step1)

set team = RS_ONE("Team")
set customerID = RS_ONE("CustomerID")
sql_step2 = "select ID EventID, * from dbo.f_most_recent_events ( '" & team & "' , " & customerID & ")"
...
<td bgcolor="#C5D3E7" align="center"><font face="Verdana, arial" size="1" color="#000000"><b>Event&nbsp;</b></font></td>
...
WHILE     Not RS.EOF
          ...
          Response.Write  "<td bgcolor="& color1 &"> <font face='Verdana, arial' size=1> " & RS("EventID") & "</font></td>"
