...
<h2 ALIGN=CENTER>Report 8: Balance Sheet </h2>
...
SQL = "dbo.BalanceSheet 0,0," & uid &",'CorpTax' "
...
<tr><td>&nbsp;</td><td>Current Assets:  </td><td> BankBalanceClose is the closing blalnce on the account. if negative it should be put as a liability </td></tr>
<tr><td>&nbsp;</td><td> &nbsp;</td><td> InvoicesUnpaid refers to the total sales invoices in this period that were not fully paid by period end. <br>
 invoices from previous periods are assumed as bad_debt </td></tr>

<tr><td>g.</td> <td>Bank Movement</td><td>  Closing Balance - opening balance </td></tr>



<tr><td>f.</td> <td>Creditors </td><td>
                    this is primarily the HSBC business bank loan
...
<tr><td>h</td><td> Directors Loan (rolling)  </td>  <td> Total Rolling Balance of Loan to Director.  Negative figures indicates a net deposit by Directors into company <br>
positive (green) is a current asset for the company
</td></tr>


<tr><td>h</td><td> Directors net drawings in this period.  </td>  <td> Negative figures indicate a net deposit by Directors into company</td></tr>
