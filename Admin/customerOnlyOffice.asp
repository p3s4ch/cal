...
<%
    ...
    if trim(CustomerID) = "" then CustomerID=2001 end if
    ...
    if CustomerID = -1 then
		...
		ReqInv=trim(RSCustomers("ReqInv"))
...
<tr>
<td bgcolor="#DAE3F0"><font face="Verdana" size="1" color="48576C"><b>ReqInv (CatB in cEvents: 3=std )</b></font></td>
<td bgcolor="#DAE3F0"></td>
<td bgcolor="#DAE3F0"><input type="text" name="ReqInv" value="<%=ReqInv%>" class="inputbox" size="50" maxlength="255"></td>
</tr>
