...
RSEVENTS.addnew
StartTime = request("Date_Month") + "/" + request("Date_Day") + "/" + request("Date_Year") + " " + request("Time_Hour") + ":" + request("Time_Minute") + ":00 " + request("Time_AMPM")
EndTime = request("Date_Month2") + "/" + request("Date_Day2") + "/" + request("Date_Year2") + " " + request("Time_Hour2") + ":" + request("Time_Minute2") + ":00 " + request("Time_AMPM2")

RSEVENTS("Title") = request("Event_Name")
RSEVENTS("Details") = request("Description")
...
'	RSEVENTS("Details") = Null
'Else
'	RSEVENTS("Details") = request("Location")
'End If
...
<%If IsDate(request("Date_Month") + "/" + request("Date_Day") + "/" + request("Date_Year")) Then%>
The event has been added.<br><br>
