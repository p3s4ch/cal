...
<TR><TD>Purchases (Materials)     </TD>  <TD>  <%= Purchases15 %>           </TD><TD> <%= Purchases15 %>         </TD><TD> <%= Purchases14 %>         </TD><TD> <%= Purchases13 %>         </TD><TD> <%= Purchases12 %>       </TD><TD> <%= Purchases11 %> </TD>      <TD> <%= Purchases10 %></TD> </TR>
