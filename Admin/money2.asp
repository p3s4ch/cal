...
<font face="Verdana" size="1" color="48576C"><b>Between &nbsp;</font>
	<script type="text/javascript" src="inc/popupWindow.js"></script>
	<input type="text" name="StartDate" id="fromRange" maxlength="10" size="8" value=<%=StartDate%> />
	<a href="javascript:;"
 ...
 &nbsp; <font face="Verdana" size="1" color="48576C"><b> AND &nbsp;</b></font>
	...
	<input type="text" name="EndDate" id="EndDate" maxlength="10" size="8" value=<%=EndDate%> />
