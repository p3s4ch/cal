...
<h2 ALIGN=CENTER>Account : Borehamwood Eruv </h2>
...
SQL_WhereBetween = " where [DateOfInvoice] BETWEEN '" & betweenFrom &"'  AND  '" & betweenTo & "' " & SQL_whereCus

SQL_Where = SQL_WhereBetween & SQL_SearchFor



SQL = "select top 10 * from dbo.invoices " &  SQL_Where  & " order by [DateOfInvoice] desc"
Response.Write "<br>" & SQL & "<br>"

SQL_TOT = "select sum(totalInclVAT) as tot from dbo.invoices " &  SQL_Where
