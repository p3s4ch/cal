...
<form action="reservations.asp?filter=Next7" name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="periodID" value="700" />
<input type="hidden" name="filter" value="next7" /> &nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="Arrivals in Next 7 Days" class="inputSubmit">
</form>

<form action="reservations.asp?filter=checkOuts7" name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
<input type="hidden" name="periodID" value="700" />
<input type="hidden" name="filter" value="next7" /> &nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="Checkouts in Next 7 Days" class="inputSubmit">
</form>


<form action="reservations.asp?periodID=20" name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> /> &nbsp; &nbsp; &nbsp;
...
<form action="reservations_add.asp" name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
&nbsp; &nbsp; &nbsp;
...
if (filterDays="checkOuts7") Then
    SQL = "select ID, Booking,Source,FirstName,Surname,Departure, RoomType, RoomNum, Status  from vReservationDetail "
    SQL_Where = " where  Departure between  " & betweenFrom & " And " betweenTo "
    SQL = SQL & SQL_Where
    Response.Write SQL
    Response.end
End If
