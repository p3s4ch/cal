...
<h2 ALIGN=CENTER>HSBC BANK STATEMENTS &nbsp;&nbsp;&nbsp; &nbsp;<img src="common\hsbc-logo.gif"> </h2>
...
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="HSBC ACCOUNT" class="inputSubmit">
</form></td>

<td><form action="HSBC_BIBbyMonth.asp?uid=<%=uid%>"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="HSBC Bank Items Grouped by Month" class="inputSubmit">
</form></td>

<td><form action="HSBC_BUS.asp?uid=<%=uid%>"  name="frmUser" Method="GET">
<input type="hidden" name="uid" value=<%=uid%> />
&nbsp; &nbsp; &nbsp;
<input type="submit" name="Submit" value="HSBC BUSINESS CARDS" class="inputSubmit">
</form></td>
</tr>
</table>
...
SQL = "select * from vHSBC_BIB " &  SQL_Where  & " order by [date] desc"
Response.Write "<br>" & SQL & "<br>"

SQL_tot  =  "select IsNull(sum(IsNull(amount,0)),0)  as tot from vHSBC_BIB " &  SQL_Where
