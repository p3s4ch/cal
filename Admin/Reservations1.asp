...
if (filterDays="next7") Then

    SQL_WhereBetween = " where [StartTime] BETWEEN getDate() AND DateAdd(dd,7,getDate()) "
End If
...
'SQL = "select * from dbo.fees " &  SQL_Where  & " order by [StartTime] desc"
