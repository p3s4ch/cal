...
if isAnID AND Not isOverride then
 %>
  <tr>
  <td bgcolor="<%=clr%>" ><font face="Verdana"  color="48576C" size="1">  <b><%=x.Name%> </b></font></td>
  <td bgcolor="<%=clr%>" > </td>
...
if isStaffTransfer then
  SQL_DropDown="select * from UserRoles where Role='hasCashAccount' "
