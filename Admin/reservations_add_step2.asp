...
<input type=hidden name=DBduration value=<%=duration%> >
 ...
 <option durMin=0 durHr=1 durNights=1  value=60  price=0.00 >1 night </option>
 <option durMin=0 durHr=2 durNights=1 value=120 price=0.00 >2 night &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;.&nbsp;&nbsp;&nbsp;&nbsp;............................................</option>
 <option durMin=0 durHr=3 durNights=1 value=180 price=0.00 >3 night &nbsp;</option>
 <option durMin=0 durHr=4 durNights=1 value=240 price=0.00 >4 night &nbsp;</option>
 <option durMin=0 durHr=5 durNights=1 value=300 price=0.00 >5 night &nbsp;</option>
 <option durMin=0 durHr=6 durNights=1 value=360 price=0.00 >6 night &nbsp;</option>
 <option durMin=0 durHr=7 durNights=1 value=420 price=0.00 >7 night &nbsp;</option>
 <option durMin=0 durHr=8 durNights=1 value=480 price=0.00 >8 night &nbsp;</option>
...
<td bgcolor="#C5D3E7">&nbsp;&nbsp;</td>
<td bgcolor="#C5D3E7">&nbsp;&nbsp;</td>
<td bgcolor="#C5D3E7">  <input type="checkbox" name="isNR" VALUE="1" <%=isCHECKED%> " >
                        <font face="Verdana" size="1" color="48576C"><b>NON-REFUNDABLE</b>
                        </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
...
<tr>
<td bgcolor="#C5D3E7"><font face="Verdana" size="1" color="48576C"><b>card number</b></font></td>
<td bgcolor="#C5D3E7"></td>
<td bgcolor="#C5D3E7"><input type="text" name="Address" class="inputbox" size="50" maxlength="255" value= "<%=SiteAddress%>" >
<font face="Verdana" size="1" color="48576C"><b>&nbsp;CVC</b></font>
<input type="text" name="CVC" class="inputbox" size="10" maxlength="255" value= "<%=trim(CVC)%>" ></td>
</tr>

<tr>
<td bgcolor="#DAE3F0"><font face="Verdana" size="1" color="48576C"><b>card details</b></font></td>
<td bgcolor="#DAE3F0"></td>
<td bgcolor="#DAE3F0"><textarea name="card" class="inputbox" cols="85" rows="5"> <%=sDetails%> </textarea>
</td>
</tr>
...
<tr>
<td bgcolor="#C5D3E7""><font face="Verdana" size="1" color="48576C"><b>Bill to be charged by the establishment   &nbsp;  </b></font></td>
<td bgcolor="#C5D3E7""></td>
...
<input type="checkbox" name="cpTo" VALUE="1"  >
                        <font face="Verdana" size="1" color="48576C"><b>copy
                        <input type="checkbox" name="mvTo" VALUE="1"   >
						Source of Booking:</b></font>&nbsp;

					    <span id="moveTowho">

						<select name=Source>
						<option value="BudgetPlaces" SELECTED>BudgetPlaces</option>
