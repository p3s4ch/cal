...
<a href="http://79.171.34.90/eComm/takeOff.php?gc=23&discounted_amount=<%= totIncVat %>&orderid=<%=orderid%>" >
         pay now by </i> <img src =gif/credit_card_logos_20.jpg  height="24" width="80"  />  </a> &nbsp; &nbsp; </td>
</tr>
