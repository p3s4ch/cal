...
<!-------------------------------------------------Form------------------------------------------------------->
<form action="AvailSlotsBooked.asp" name="frmUser" Method="Post" onSubmit="return VerifyData()">
...
<!-------------------------------------------------Operators------------------------------------------------------->
<!--#include file="common/select_operator.asp"-->
...
<tr>
<td bgcolor="#DAE3F0"><font face="Verdana" size="1" color="48576C"><b>Category of Availability</b></font></td>
<td bgcolor="#DAE3F0"></td>
<td bgcolor="#DAE3F0">
