...
<h2 ALIGN=CENTER>Useful SQL Tools for Reservations</h2>
...
if (filterDays="AvailFromTodaysCheckOuts" ) Then
    ...
    SQL_TOT = "select count(*) as tot from dbo.f_RoomsFreeOnTonight ( getDate() )"
END IF
...
Response.Write "<br><br> <b>Total Rooms &nbsp; " & RS_TOT("tot") & "</b><br><br>"
