...
<form action="Preferences_add.asp" name="frmUser" Method="GET">
...
<!--#include file="common\update_Preferences.asp"-->
...
if isAnID then
 %>
   <td bgcolor="<%=color1%>">
   <a href=Preferences_add.asp?uid=<%= uid %>&ID=<%= x.value %>><font face="Verdana, arial" size="1" color=red>edit</font></a></td>
 <%
 end if
 if Not isAnID then
 %>
