...
<%
OverridePeriodIDPreference=20

Response.Write "periodID = "& periodID
%>
...
SQL = "select StartTime, Details , Category, CustomerID, BillTotal, SiteAddress, SitePostCode,Operator, Confirmed from cEvents " &  SQL_Where  & " order by [StartTime] desc"
Response.Write "<br>" & SQL & "<br>"

SQL_TOT = "select sum(BillTotal) as tot from dbo.cEvents " &  SQL_Where
