...
SQL_SELECT_ALL =  "select top 40 ID id2New_Ext , ID id2edit_Ext, ID [#],  Board, Agency, Telephone , Contact, Mobile, Title , Client , Status , Date , EnteredBy [PKU] from dbo.vRvRecruiters " & SQL_Where
