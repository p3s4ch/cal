...
<h2 ALIGN=CENTER>HSBC BUSINESS CREDIT CARD STATEMENTS </h2>
...
SQL = "select * from vHSBC_BUS " &  SQL_Where  & " order by [date] desc"
Response.Write "<br>" & SQL & "<br>"

SQL_tot  =  "select IsNull(sum(IsNull(amount,0)),0)  as tot from vHSBC_BUS " &  SQL_Where
