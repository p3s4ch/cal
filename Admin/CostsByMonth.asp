...
<h2 ALIGN=CENTER>Costs By Month </h2>
<img src="hsbc.bmp" />
...
Response.Write "PRO_SERVICES = Professional Services (CORGI Gas engineers, Building Architects, Surveyors, Electricians etc)"
...
SQL = "exec [dbo].[pCosts] '" & betweenFrom & "' , '" & betweenTo &"'" 
