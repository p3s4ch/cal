...
VAT Paid is calculated on actual payments in the HSBC Bank transactions during the given period [For VAT of previous periods]<br>
...
<!--#include file="common\update_vat.asp"-->

<%

if orderBy <> "" then SqlorderBy=" order by " &  orderBy end if

SQL_WhereBetween = " where [PeriodStart] BETWEEN '" & betweenFrom &"'  AND  '" & betweenTo & "' "
...
SQL = "select * from dbo.vVAT " &  SQL_Where  & " order by [PeriodStart] "
