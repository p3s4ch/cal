...
<option value="-1" <%=noCustomerSelected%>  firstName="" Surname="" Address="" Postcode="" Phone="" Mobile="" Email="" >
select or add new</option>
<%

Set RSCustomers = Server.CreateObject("ADODB.Recordset")

RSCustomers.Open "select Title, Email, Surname, FirstName, ID,  Address,Postcode ,Phone, Mobile, Comment from  telphoneBook order by Surname", SQLCN, 2, 2
...
Surname="<%=RSCustomers("Surname")%>" Address="<%=RSCustomers("Address")%>" Mobile="<%=RSCustomers("Mobile")%>"
Phone="<%=RSCustomers("Phone")%>" Postcode="<%=RSCustomers("Postcode")%>"  Email="<%=RSCustomers("Email")%>"  >
