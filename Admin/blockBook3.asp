...
<option value="2hr" SELECTED>2 hours</option>
...
<tr>
   <td bgcolor="#DAE3F0">
   <input type="radio" name="recurrence" VALUE="hourly" <%=isdailyCHECKED%> onclick="RadioChanged(this)">
   <font face="Verdana" size="1" color="48576C"><b>                            Hourly:
   </font></td><td bgcolor="#DAE3F0"></td>
   <td bgcolor="#DAE3F0"><font face="Verdana" size="1" color="48576C">
             Every &nbsp;<input type="text" name="hourlyEveryXhours" size=1 value=2> &nbsp; hour(s)   &nbsp;&nbsp; </font></td>
</tr>
...
<tr>
   <td bgcolor="#DAE3F0">
   <input type="radio" name="recurrence" VALUE="daily" <%=isdailyCHECKED%> >
   <font face="Verdana" size="1" color="48576C"><b>                            Daily:
   </font></td><td bgcolor="#DAE3F0"></td>
   <td bgcolor="#DAE3F0">
       <font face="Verdana" size="1" color="48576C">
       Every &nbsp;<input type="text" name="dailyEveryXdays" size=1> &nbsp; day(s)   </font></td>
</tr>
...
<td bgcolor="#DAE3F0"><font face="Verdana" size="1" color="48576C">
        ...
        &nbsp;<input type="text" name="yearlyOntheMonthOfX" value="March" size=5> </font>
</td>
</tr>
