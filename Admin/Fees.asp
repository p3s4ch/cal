...
<input type="hidden" name="tableName" value="FeesGS" />
<input type="hidden"      name="bttns" value="Fees.Buttons" />
<input type="hidden"      name="mysql"
value="select  '-1' ID, '' Payer_Ext ,  getDate() as D_ateEntryTime_Ext , '' Amount, '' Comment " />
...
tots = RS_TOT("tot")
Response.Write "<br><br> <b>Total &nbsp; &pound; " & tots & "</b><br>"
