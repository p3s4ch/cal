...
IF isCustomer THEN
    ...
    sqlTop="exec MostRecentEvents '"& team &"'," & CustomerID &",0 "

    ELSE

       IF  isGuest THEN
             Response.Write " g. <br>"
	        sqlTop="exec MostRecentEvents '"& team &"'," & CustomerID &",1 , " & uid
       ELSE
            'staff
            sqlTop="exec MostRecentEvents '"& team &"'," & CustomerID &",0 , " & uid
       END IF
END IF

sqlTop="exec MostRecentEvents2 "& uid
